                ...
                <Box sx={{padding:"5%",textAlign:"center"}}>
                  ...
                  <Box sx={{display:"flex",justifyContent:"center",margin:"20px 0px 0px 0px"}}>
                    <Stack directio="col" spacing={4} sx={{width:"600px"}}>
                        ...
                        <Box>
                          <Button variant="contained" size="medium"  sx={{boxShadow:"none",borderRadius:"0px",padding:"7px 20px 7px 25px",marginTop:"10px",color:"#a04e4e",background: 'none',border:"1px solid #a04e4e","&:hover": {backgroundColor: '#a04e4e',color:"white"}}}>Login</Button>
                        </Box> 
                    </Stack>  
                   </Box>
                   </form>
                   ...
                   <Typography sx={{color:"#666666",fontFamily:'Helvetica',fontSize:"18px",marginTop:"15px",letterSpacing:"2px",fontWeight:"500"}}>Don't have an account ? <a href='' className="footerLink" style={{color:"#a04e4e"}}> Sign Up</a></Typography>
