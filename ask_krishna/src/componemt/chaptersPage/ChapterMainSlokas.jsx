...
function ChapterMainSlokas({sloka}) {
        ...
        <Box sx={{textAlign:"left",height:"550px"}}>
            ...
            {sloka.map((ele,index)=>{
                ...
                <Stack sx={{padding:"1.5% 4%",margin:"4% 1%",boxShadow:"0px 0px 5px #a04e4e"}}>
                    ...
                    <Box>
                        <Button variant="contained" size="medium"  sx={{boxShadow:"none",borderRadius:"0px",padding:"7px 20px 7px 25px",marginBottom:"20px",color:"#a04e4e",background: 'none',border:"1px solid #a04e4e","&:hover": {backgroundColor: '#a04e4e',color:"white"}}}
                        onClick={()=>{
                          navigate('/shloka-overview')
                        }}
                        >open verse</Button>
                    </Box> 
                </Stack>)
